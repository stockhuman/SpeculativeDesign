import { Math as Maths, Vector3 } from 'three/src/Three'
...
class FirstPersonControls {
  ...
  update( delta ) {
    ...
    if ( this.heightSpeed ) {
      ...
      var y = Maths.clamp( this.object.position.y, this.heightMin, this.heightMax );
    ...
    this.phi = Maths.degToRad( 90 - this.lat );

    this.theta = Maths.degToRad( this.lon );

    if ( this.constrainVertical ) {

      this.phi = Maths.mapLinear( this.phi, 0, Math.PI, this.verticalMin, this.verticalMax );
    }
